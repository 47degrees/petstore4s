...
Discussion around _petstore4s_ happens in the [GitHub issues](https://github.com/47degrees/petstore4s/issues) and [pull requests](https://github.com/47degrees/petstore4s/pulls).

Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about
the code. Pull requests are also welcome.

People are expected to follow the [Code of Conduct](CODE_OF_CONDUCT.md) when discussing _petstore4s_ on the Github page or other venues.
...
_petstore4s_ follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
